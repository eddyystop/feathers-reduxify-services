...
var reduxifyService = function reduxifyService(app, route) {
  ...
  return {
    ...
    store: (0, _reduxActions.createAction)(STORE),
    ...
    _defineProperty({}, RESET, function (state, action) {
      ...
      return _extends({}, state, (_extends5 = {}, _defineProperty(_extends5, opts.isError, null), _defineProperty(_extends5, opts.isLoading, false), _defineProperty(_extends5, opts.isSaving, false), _defineProperty(_extends5, opts.isFinished, false), _defineProperty(_extends5, opts.data, null), _defineProperty(_extends5, opts.queryResult, action.payload ? state[opts.queryResult] : null), _defineProperty(_extends5, opts.store, null), _extends5));
    }),

    // update store
    _defineProperty({}, STORE, function (state, action) {
      debug('redux:' + STORE, action);

      return _extends({}, state, _defineProperty({}, opts.store, action.payload));
    })), (_handleActions = {}, _defineProperty(_handleActions, opts.isError, null), _defineProperty(_handleActions, opts.isLoading, false), _defineProperty(_handleActions, opts.isSaving, false), _defineProperty(_handleActions, opts.isFinished, false), _defineProperty(_handleActions, opts.data, null), _defineProperty(_handleActions, opts.queryResult, null), _defineProperty(_handleActions, opts.store, null), _handleActions))
  };
};
